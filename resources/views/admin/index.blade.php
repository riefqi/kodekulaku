                     ...
                     <table id="basic-table" class="table mb-0 table-striped" role="grid">
                        ...
                        <tbody>
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="public/assets/images/shapes/01.png" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="public/assets/images/shapes/05.png" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="public/assets/images/shapes/02.png" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="public/assets/images/shapes/03.png" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="public/assets/images/shapes/04.png" alt="profile">
